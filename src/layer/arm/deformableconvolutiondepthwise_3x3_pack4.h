...
static void dfmconvdw3x3s2_pack4_neon(const Mat& bottom_blob, Mat& top_blob, const Mat& kernel, const Mat& offset, Mat& ofs_idx, const Mat& _bias, const Option& opt)
{
#if 0
    int w = bottom_blob.w;
